/*ep 7 :- The Scope Chain, Scope & Lexical Environment namaste js
...
--> So, Lexical Environment = local memory + lexical env of its parent. 

--> Hence, Lexical Environement is the local memory along with the
lexical environment of its parent

--> Lexical: In hierarchy, In order Whenever an Execution Context is created,
a Lexical environment(LE) is also created and is referenced in the local
...
--> Lexical or Static scope refers to the accessibility of variables, functions and object based on physical location in
source code.
...
--> Inner is surrounded by lexical scope of Outer TLDR; 
